    ...
    public class ServisController : ApiController
    {
        ...
        public List<UrunModel> UrunListele()
        {
            List<UrunModel> liste = db.Urun.Select(x => new UrunModel()
            {
                ...
                urunKat = x.urunKat,
                urunDeger = x.urunDeger,
                urunStok = x.urunStok,
                urunResim = x.urunResim,
                urunKayit = x.urunKayit,
                urunDuzenlenme = x.urunDuzenlenme,
                urunSecili = x.urunSecili,
            }).ToList();
            return liste;
        }
        ...
        public SonucModel UrunDuzenle(UrunModel model)
        {
            ...
            kayit.urunDeger = model.urunDeger;
            kayit.urunStok = model.urunStok;
            kayit.urunResim = model.urunResim;
            kayit.urunKayit = model.urunKayit;
            kayit.urunDuzenlenme = model.urunDuzenlenme;
            kayit.urunSecili = model.urunSecili;
        ...
        public SonucModel UrunEkle(UrunModel model)
        {
            ...
            yeni.urunDeger = model.urunDeger;
            yeni.urunStok = model.urunStok;
            yeni.urunResim = model.urunResim;
            yeni.urunKayit = model.urunKayit;
            yeni.urunDuzenlenme = model.urunDuzenlenme;
            yeni.urunSecili = model.urunSecili = 1;
